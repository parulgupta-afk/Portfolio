...
export const PROJECTS_DATA: ProjectItem[] = [
  {
    ...
    imageUrl: 'https://picsum.photos/seed/priceloop-price/1600/900',
    ...
    decisions: [
      {
        ...
        problem: 'Schema changes must be safe and repeatable toward production',
        options: ['create_all only', 'Hand-written SQL', 'Alembic migrations'],
        chosen: 'Alembic migrations (prod path)',
        reason: 'Explicit upgrade/downgrade history; prod compose runs migrate before app start',
      },
      {
